...
import { COUNCIL_EQUIPMENT_DEFAULTERS_LIST_BY_TEAM } from 'pages/campaigns/CampaignQueries'
import ApolloWrapper from 'components/base-component/ApolloWrapper'
import { HeadingPrimary } from 'components/HeadingPrimary/HeadingPrimary'
import HeadingSecondary from 'components/HeadingSecondary'
import PullToRefresh from 'react-simple-pull-to-refresh'

function CouncilEquipmentHaveNotFilledByTeam() {
  ...
  const { data, loading, error, refetch } = useQuery(
    COUNCIL_EQUIPMENT_DEFAULTERS_LIST_BY_TEAM,
    {
      variables: {
        councilId: councilId,
      },
  ...
  const defaulters = data?.councils[0]?.teamEquipmentNotFilled
...
export default CouncilEquipmentHaveNotFilledByTeam
