...
import { CAMPUS_EQUIPMENT_DEFAULTERS_LIST_BY_GOVERNORSHIP } from 'pages/campaigns/CampaignQueries'
import ApolloWrapper from 'components/base-component/ApolloWrapper'
import { HeadingPrimary } from 'components/HeadingPrimary/HeadingPrimary'
import HeadingSecondary from 'components/HeadingSecondary'
import PullToRefresh from 'react-simple-pull-to-refresh'

function CampusEquipmentHaveNotFilledByGovernorship() {
  ...
  const { data, loading, error, refetch } = useQuery(
    CAMPUS_EQUIPMENT_DEFAULTERS_LIST_BY_GOVERNORSHIP,
    {
      variables: {
        campusId: campusId,
      },
  ...
  const defaulters = data?.campuses[0]?.governorshipEquipmentNotFilled
...
export default CampusEquipmentHaveNotFilledByGovernorship
