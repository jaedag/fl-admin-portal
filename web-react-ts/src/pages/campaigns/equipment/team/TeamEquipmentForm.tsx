...
import { CREATE_TEAM_EQUIPMENT_RECORD } from '../../CampaignQueries'
...
const TeamEquipmentForm = () => {
  const { currentUser } = useContext(MemberContext)
  const { teamId } = useContext(ChurchContext)
  const church = currentUser.currentChurch
  const churchType = currentUser.currentChurch?.__typename

  const [CreateEquipmentRecord] = useMutation(CREATE_TEAM_EQUIPMENT_RECORD)
  ...
  const onSubmit = async (
    ...
    navigate('/campaigns/team/equipment/form-details')
  }
...
export default TeamEquipmentForm
