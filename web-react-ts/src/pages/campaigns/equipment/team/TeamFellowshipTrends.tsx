...
import { FELLOWSHIP_RECORDS_PER_TEAM } from '../../CampaignQueries'
...
const TeamFellowshipTrends = () => {
  ...
  const { data, loading, error } = useQuery(FELLOWSHIP_RECORDS_PER_TEAM, {
    variables: { teamId: teamId },
  })
  const fellowships = data?.teams[0]?.bacentas[0]?.fellowships
...
export default TeamFellowshipTrends
