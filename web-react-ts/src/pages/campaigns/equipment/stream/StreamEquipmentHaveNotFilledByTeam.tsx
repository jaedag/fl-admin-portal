...
import { STREAM_EQUIPMENT_DEFAULTERS_LIST_BY_TEAM } from 'pages/campaigns/CampaignQueries'
import ApolloWrapper from 'components/base-component/ApolloWrapper'
import { HeadingPrimary } from 'components/HeadingPrimary/HeadingPrimary'
import HeadingSecondary from 'components/HeadingSecondary'
import PullToRefresh from 'react-simple-pull-to-refresh'

function StreamEquipmentHaveNotFilledByTeam() {
  ...
  const { data, loading, error, refetch } = useQuery(
    STREAM_EQUIPMENT_DEFAULTERS_LIST_BY_TEAM,
    {
      variables: {
        streamId: streamId,
      },
  ...
  const defaulters = data?.streams[0]?.teamEquipmentNotFilled
...
export default StreamEquipmentHaveNotFilledByTeam
