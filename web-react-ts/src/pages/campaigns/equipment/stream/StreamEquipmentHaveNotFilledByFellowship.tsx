...
import { STREAM_EQUIPMENT_DEFAULTERS_LIST_BY_FELLOWSHIP } from 'pages/campaigns/CampaignQueries'
import ApolloWrapper from 'components/base-component/ApolloWrapper'
import { HeadingPrimary } from 'components/HeadingPrimary/HeadingPrimary'
import HeadingSecondary from 'components/HeadingSecondary'
import PullToRefresh from 'react-simple-pull-to-refresh'

const StreamEquipmentHaveNotFilledByFellowship = () => {
  ...
  const { data, loading, error, refetch } = useQuery(
    STREAM_EQUIPMENT_DEFAULTERS_LIST_BY_FELLOWSHIP,
    {
      variables: {
        streamId: streamId,
      },
  ...
  const defaulters = data?.streams[0]?.fellowshipEquipmentNotFilled
...
export default StreamEquipmentHaveNotFilledByFellowship
