...
import { TEAM_MULTIPLICATION_GRAPHS } from '../MultiplicationQueries'

const TeamMultiplicationCampaignTrends = () => {
  ...
  const { data, loading, error } = useQuery(TEAM_MULTIPLICATION_GRAPHS, {
    variables: { teamId },
    onCompleted: (data) => {
      if (!setChurchData) return
      setChurchData(
        getServiceGraphData(data?.teams[0], 'multiplicationAggregate')
      )
    },
...
export default TeamMultiplicationCampaignTrends
