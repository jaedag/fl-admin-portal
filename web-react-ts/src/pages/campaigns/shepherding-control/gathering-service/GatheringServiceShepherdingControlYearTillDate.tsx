...
const GatheringServiceShepherdingControlYearTillDate = () => {
  ...
  const [gatheringServiceStatForYearTillDate, { data, loading, error }] =
    useLazyQuery(GATHERING_SERVICE_STAT_FOR_YEAR_TILL_DATE)
  ...
  const onSubmit = (
    ...
    gatheringServiceStatForYearTillDate({
      variables: {
        gatheringServiceId,
  ...
  const statsForYearTillDate = data?.gatheringServices[0]?.statsForYearTillDate
...
export default GatheringServiceShepherdingControlYearTillDate
