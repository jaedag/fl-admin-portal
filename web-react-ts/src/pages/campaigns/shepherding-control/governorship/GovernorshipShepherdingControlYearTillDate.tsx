...
import { GOVERNORSHIP_STAT_FOR_YEAR_TILL_DATE } from '../ShepherdingControlQueries'
...
const GovernorshipShepherdingControlYearTillDate = () => {
  ...
  const [governorshipStatForYearTillDate, { data, loading, error }] =
    useLazyQuery(GOVERNORSHIP_STAT_FOR_YEAR_TILL_DATE)
  ...
  const onSubmit = (
    ...
    governorshipStatForYearTillDate({
      variables: {
        governorshipId,
  ...
  const statsForYearTillDate = data?.governorships[0]?.statsForYearTillDate
...
export default GovernorshipShepherdingControlYearTillDate
