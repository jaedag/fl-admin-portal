...
import { COUNCIL_STAT_FOR_YEAR_TILL_DATE } from '../ShepherdingControlQueries'
...
const CouncilShepherdingControlYearTillDate = () => {
  ...
  const [councilStatForYearTillDate, { data, loading, error }] = useLazyQuery(
    COUNCIL_STAT_FOR_YEAR_TILL_DATE
  )
  ...
  const statsForYearTillDate = data?.councils[0]?.statsForYearTillDate
  ...
  return (
    <Container>
      ...
      <h6 className="text-primary">Stats Till Date(2022)</h6>
      <Formik
...
export default CouncilShepherdingControlYearTillDate
