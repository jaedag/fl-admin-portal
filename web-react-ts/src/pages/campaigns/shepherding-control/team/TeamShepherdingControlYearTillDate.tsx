...
import { TEAM_STAT_FOR_YEAR_TILL_DATE } from '../ShepherdingControlQueries'
...
const TeamShepherdingControlYearTillDate = () => {
  ...
  const [teamStatForYearTillDate, { data, loading, error }] = useLazyQuery(
    TEAM_STAT_FOR_YEAR_TILL_DATE
  )
  ...
  const statsForYearTillDate = data?.teams[0]?.statsForYearTillDate
...
export default TeamShepherdingControlYearTillDate
