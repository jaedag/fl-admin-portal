...
import { BACENTA_STAT_FOR_YEAR_TILL_DATE } from '../ShepherdingControlQueries'
...
const BacentaShepherdingControlYearTillDate = () => {
  ...
  const [bacentaStatForYearTillDate, { data, loading, error }] = useLazyQuery(
    BACENTA_STAT_FOR_YEAR_TILL_DATE
  )
  ...
  const statsForYearTillDate = data?.bacentas[0]?.statsForYearTillDate
...
export default BacentaShepherdingControlYearTillDate
