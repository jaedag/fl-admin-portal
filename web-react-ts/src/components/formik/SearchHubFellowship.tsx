...
import { MEMBER_HUBFELLOWSHIP_SEARCH } from './SearchHubFellowshipQueries'
import TextError from './TextError/TextError'

const SearchHubFellowship = (props: RoleBasedSearch) => {
...
export default SearchHubFellowship
