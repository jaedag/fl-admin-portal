...
RETURN DISTINCT date.date as date, stream.name as stream, bacenta.name as bacenta, (stream.arrivalsPrefix+toString(bacenta.bacentaCode)) as bacentaCode, record.leaderDeclaration as attendance, record.attendance as confirmedAttendance, record.vehicle as vehicle, 
(CASE 
