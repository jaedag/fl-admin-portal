...
MATCH (church {id: $churchId}) WHERE church:Team OR church:Council OR church:Stream OR church:Campus
...
WHERE church:Team OR church:Council OR church:Stream OR church:Campus OR church:Oversight OR church:Denomination
...
MATCH (record)<-[:HAS_MULTIPLICATION_RECORD]-(:ServiceLog)<-[:HAS_HISTORY]-(church) WHERE church:Team OR church:Council OR church:Stream OR church:Campus
